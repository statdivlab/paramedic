...
For details on the hierarchical modelling options available in `paramedic`, see [the vignette on hierarchical model specificaion](docs/articles/hierarchical_model_specification.html).
