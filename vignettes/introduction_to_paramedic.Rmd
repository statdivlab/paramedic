...
For details on the hierarchical modelling options available in `paramedic`, see [the vignette on hierarchical model specificaion](https://bdwilliamson.github.io/paramedic/hierarchical_model_specification.html).
