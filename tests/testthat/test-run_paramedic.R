...
test_that("paramedic works", {
  ...
  expect_equal(mean(mod_summ[grepl("mu", rownames(mod_summ)) & grepl(",1]", rownames(mod_summ)), 1]), mean(example_qPCR_data$Gardnerella.vaginalis), tolerance = 2000)
})
...
test_that("centered-paramedic works", {
  ...
  expect_equal(mean(mod_summ_c[grepl("mu", rownames(mod_summ_c)) & grepl(",1]", rownames(mod_summ_c)), 1]), mean(example_qPCR_data$Gardnerella.vaginalis), tolerance = 2000)
})
