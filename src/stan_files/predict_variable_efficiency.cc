...
#include "predict_variable_efficiency.hpp"

RCPP_MODULE(stan_fit4predict_variable_efficiency_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_predict_variable_efficiency")
