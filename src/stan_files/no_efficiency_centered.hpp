...
namespace model_no_efficiency_centered_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_no_efficiency_centered");
    reader.add_event(28, 26, "end", "model_no_efficiency_centered");
    return reader;
}

#include <meta_header.hpp>
 class model_no_efficiency_centered : public prob_grad {
private:
    int N;
    int q_obs;
    int q;
    ...
    double sigma_Sigma;
public:
    model_no_efficiency_centered(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_no_efficiency_centered_namespace::model_no_efficiency_centered";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(mu,i,"mu",1), beta_0, Sigma));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_no_efficiency_centered_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_no_efficiency_centered";
    }
...
typedef model_no_efficiency_centered_namespace::model_no_efficiency_centered stan_model;
