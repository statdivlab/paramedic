...
namespace model_no_efficiency_centered_covariates_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_no_efficiency_centered_covariates");
    reader.add_event(37, 35, "end", "model_no_efficiency_centered_covariates");
    return reader;
}

#include <meta_header.hpp>
 class model_no_efficiency_centered_covariates : public prob_grad {
private:
    int N;
    int q_obs;
    int q;
    ...
    double sigma_Sigma;
public:
    model_no_efficiency_centered_covariates(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_no_efficiency_centered_covariates_namespace::model_no_efficiency_centered_covariates";
    ...
    ~model_no_efficiency_centered_covariates() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_no_efficiency_centered_covariates_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_no_efficiency_centered_covariates";
    }
...
typedef model_no_efficiency_centered_covariates_namespace::model_no_efficiency_centered_covariates stan_model;
