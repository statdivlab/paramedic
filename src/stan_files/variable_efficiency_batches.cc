...
#include "variable_efficiency_batches.hpp"

RCPP_MODULE(stan_fit4variable_efficiency_batches_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_variable_efficiency_batches")
