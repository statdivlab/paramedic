...
namespace model_variable_efficiency_covariates_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_variable_efficiency_covariates");
    reader.add_event(50, 48, "end", "model_variable_efficiency_covariates");
    return reader;
}

#include <meta_header.hpp>
 class model_variable_efficiency_covariates : public prob_grad {
private:
    int N;
    int q_obs;
    int q;
    ...
    double kappa_sigma;
public:
    model_variable_efficiency_covariates(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_variable_efficiency_covariates_namespace::model_variable_efficiency_covariates";
    ...
    ~model_variable_efficiency_covariates() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int j = 1; j <= q; ++j) {
                    ...
                    stan::model::assign(mu, 
                                ...
                                stan::math::exp(((get_base1(beta_0,j,"beta_0",1) + multiply(get_base1(X,i,"X",1),get_base1(beta_1,j,"beta_1",1))) + (get_base1(Sigma,j,"Sigma",1) * get_base1(get_base1(log_mu_tilde,i,"log_mu_tilde",1),j,"log_mu_tilde",2)))), 
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                lp_accum__.add(std_normal_log<propto__>(get_base1(log_mu_tilde,i,"log_mu_tilde",1)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_variable_efficiency_covariates_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_variable_efficiency_covariates";
    }
...
typedef model_variable_efficiency_covariates_namespace::model_variable_efficiency_covariates stan_model;
